...
describe('createMockExecutionAdapter', () => {
  ...
  test('creates independent success runs and emits ordered events', async () => {
    ...
    expect(events).toEqual(['run.created', 'run.queued', 'job.claimed', 'pipeline.step.started', 'pipeline.step.completed', 'context.loading', 'assistant.thinking', 'assistant.drafting', 'tool.call.approval_required', 'tool.call.succeeded', 'tool.call.approval_required', 'tool.call.succeeded', 'tool.call.approval_required', 'tool.call.succeeded', 'tool.call.approval_required', 'tool.call.succeeded', 'tool.call.succeeded', 'tool.call.approval_required', 'tool.call.succeeded', 'tool.call.succeeded', 'tool.call.succeeded', 'tool.call.approval_required', 'tool.call.succeeded', 'tool.call.succeeded', 'assistant.message.completed', 'run.completed'])
  })
