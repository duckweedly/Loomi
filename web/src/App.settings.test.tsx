...
describe('App settings surface wiring', () => {
  ...
  test('passes session locale and provider draft settings into Settings', async () => {
    ...
    expect(source).toContain('onDetectLocalProviders={() => void detectLocalProviders()}')
    expect(source).toContain('onDetectOpenVikingMemoryProvider={detectOpenVikingMemoryProvider}')
