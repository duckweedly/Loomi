...
- Added builtin `artifact.create_text`, `artifact.read`, and `artifact.list` catalog identity, default persona allowlist, Work-mode filtering, and safe tool-call metadata grouping.
...
No binary artifacts, downloads, rendered previews, iframe execution, filesystem export, browser integration, shell integration, artifact version graph, marketplace packaging, or multi-agent orchestration were added.
