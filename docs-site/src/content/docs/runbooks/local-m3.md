...
```bash
VITE_LOOMI_API_BASE_URL=http://127.0.0.1:18080
```
...
```bash
curl -s http://127.0.0.1:18080/v1/me
curl -s -X POST http://127.0.0.1:18080/v1/threads \
  -H 'Content-Type: application/json' \
  -d '{"title":"M3 smoke thread","mode":"chat"}'
curl -s http://127.0.0.1:18080/v1/threads
curl -s -X POST "http://127.0.0.1:18080/v1/threads/$THREAD_ID/messages" \
  -H 'Content-Type: application/json' \
...
```bash
cd web
VITE_LOOMI_API_BASE_URL=http://127.0.0.1:18080 bun run dev
```
